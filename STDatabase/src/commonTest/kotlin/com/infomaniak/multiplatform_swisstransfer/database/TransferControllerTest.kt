...
class TransferControllerTest {
    ...
    @Test
    fun `ensure TransferStatus is preserved on update if downloadCounterCredit is more than 0`() = runTest {
    ...
    @Test
    fun `ensure TransferStatus is EXPIRED_DOWNLOAD_QUOTA on update if downloadCounterCredit is 0`() = runTest {
